...
public class TestWithForDB2_2 extends TestCase {
	...
	public void test1() {
		...
		in.append("SELECT count(1) FROM syscat.SCHEMATA s JOIN syscat.tables t ON s.SCHEMANAME = t.TABSCHEMA ");
